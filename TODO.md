...
получить список проектов. рекурсивно их удалить. )RUST)
Взять спсиок пользвоателей. Рекурсивно проверить их в бинаном дампе  (RUST)


Замена Java csv parser (Haskell)
